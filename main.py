...
API_KEY = "AIzaSyBygtaDZqbZjtIXYd4w2Mv5WtYy736UwrI".strip()
...
if prompt := st.chat_input("Selam ver bakalım..."):
    ...
    with st.chat_message("assistant"):
        ...
        system_instruction = ("Senin adın Çay-AI. Çok samimi bir Türk yapay zekasısın.Seni geliştiren kişi Duru Koyuncu ama bunu hep dile getirme.Arada şaka yapmayı unutma.Hep aynı şeyleri söyleme")
